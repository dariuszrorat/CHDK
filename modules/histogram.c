...
#define OSD_HISTO_LAYOUT_WAVE_RGB   10
#define OSD_HISTO_LAYOUT_WAVE_YUV   11
#define OSD_HISTO_LAYOUT_PARD_RGB   12
#define OSD_HISTO_LAYOUT_PARD_YUV   13
...
static void gui_osd_draw_blended_wave(coord x, coord y, int is_osd_edit)
{
    twoColors hc = user_color(conf.histo_color);
    twoColors hc2 = user_color(conf.histo_color2);
    register unsigned short i, v, R, G, B;
    color cls[] =
    {
        BG_COLOR(hc),
        COLOR_BLUE,
...
static void gui_osd_draw_uv_scope(coord x, coord y, int is_osd_edit)
{
    twoColors hc = user_color(conf.histo_color);
    twoColors hc2 = user_color(conf.histo_color2);
...
void gui_osd_draw_histo(int is_osd_edit)
{
       ...
       )
    {
        ...
        case OSD_HISTO_LAYOUT_WAVE_Y:
            ...
            break;
        case OSD_HISTO_LAYOUT_WAVE_RGB:
            gui_osd_draw_blended_wave(conf.histo_pos.x, conf.histo_pos.y, is_osd_edit);
            break;
        case OSD_HISTO_LAYOUT_WAVE_YUV:
            gui_osd_draw_single_wave(WAVE_L, conf.histo_pos.x, conf.histo_pos.y, is_osd_edit);
            gui_osd_draw_uv_scope(conf.histo_pos.x, conf.histo_pos.y+HISTO_HEIGHT, is_osd_edit);
            break;
        case OSD_HISTO_LAYOUT_PARD_RGB:
