...
#define LANG_MENU_OPEN_ZONE_FILE                638
#define LANG_STR_SELECT_ZONE_FILE               639
#define LANG_STR_CURRENT_ZONE_SYSTEM            640
#define LANG_MENU_SHOW_ZONE_LEGEND              641
#define LANG_MENU_PARADE_MODE                   642
#define LANG_MENU_VALUES_SHOW_COLOR_TEMP_TINT   643
#define LANG_MENU_VALUES_SHOW_OVEREXP_PERCENT   644
#define LANG_MENU_VALUES_SHOW_AUTO_EV_COMP      645
#define LANG_MENU_ZEBRA_RGB_FN                  646

#define GUI_LANG_ITEMS                          646
