...
static const char* gui_overexp_ev_modes[] = { "Off", "-1/3 Ev", "-2/3 Ev", "-1 Ev", "-1 1/3Ev", "-1 2/3Ev", "-2 Ev", "Auto"};
static const char* gui_autoiso_iso_values[] = {"80", "100", "125", "160", "200", "250", "320", "400", "500", "640", "800"};
...
static CMenuItem autoiso_submenu_items[] =
{
    ...
    MENU_ENUM2	(0x5f,LANG_MENU_AUTOISO_MIN_ISO,            &conf.autoiso_min_iso,                         gui_autoiso_iso_values ),
    MENU_ENUM2	(0x5f,LANG_MENU_AUTOISO_MAX_ISO_AUTO,       &conf.autoiso_max_iso_auto,                    gui_autoiso_iso_values ),
    ...
    MENU_ENUM2	(0x5f,LANG_MENU_AUTOISO_MAX_ISO_HI,         &conf.autoiso_max_iso_hi,                      gui_autoiso_iso_values ),
    ...
    MENU_ENUM2	(0x5f,LANG_MENU_AUTOISO_MAX_ISO2,           &conf.autoiso2_max_iso_auto,                        gui_autoiso_iso_values ),
...
static const char* gui_zoom_value_modes[] =                 { "X", "FL", "EFL", "ALL" };
static const char* gui_show_values_modes[] =                { "Don't", "Always", "Shoot" };
static const char* gui_wb_values_modes[] =                  { "Don't", "Temp", "Tint", "All" };
...
static CMenuItem values_submenu_items[] =
{
    ...
    MENU_ENUM2  (0x5f,LANG_MENU_VALUES_SHOW_COLOR_TEMP_TINT, &conf3.values_show_color_temp_tint, gui_wb_values_modes ),
    MENU_ITEM   (0x5c,LANG_MENU_VALUES_SHOW_OVEREXP_PERCENT, MENUITEM_BOOL,      &conf3.values_show_overexp_percent,        0 ),
    MENU_ITEM   (0x5c,LANG_MENU_VALUES_SHOW_AUTO_EV_COMP,    MENUITEM_BOOL,      &conf3.values_show_auto_ev_comp,           0 ),
    MENU_ITEM   (0x51,LANG_MENU_BACK,                       MENUITEM_UP,        0,                                          0 ),
    {0}
};
...
{
    libpalette->show_palette(PALETTE_MODE_DEFAULT, (chdkColor)
    {
        0,0
    }, NULL);
}
...
{
    libpalette->show_palette(PALETTE_MODE_TEST, (chdkColor)
    {
        0,0
    }, NULL);
}
...
static CMenuItem histo_submenu_items[] =
{
    ...
    MENU_ENUM2(0x5f,LANG_MENU_PARADE_MODE,            &conf3.parade_mode,     gui_wave_parade_modes ),
...
//---------------------------------------------
// --  zebra zone title helper functions -----
void process_zone_string(const char *str, int n, char *dest)
{
    const char *ptr = str;
    int i;
...
void parse_zone_line(char *ptr, int maxlen)
{
    while (ptr[0])
    {
        ...
        {
            ptr+=6;
            process_zone_string(ptr, maxlen-6-1, conf2.zebra_zone_title);
        }
...
static void set_zebra_zone_title()
{
...
// ---- end of zebra zone title helper functions ------

static void gui_zones_load_selected(const char *fn)
{
    if (fn)
    {
        strcpy(conf2.zebra_zone_file, fn);
        set_zebra_zone_title();
    }
}

static void gui_zones_load(int arg)
{
    libfselect->file_select(LANG_STR_SELECT_ZONE_FILE, conf2.zebra_zone_file, "A/CHDK/ZONES", gui_zones_load_selected);
}

static void gui_menu_zone_legend(int arg)
{
    libpalette->show_palette(PALETTE_MODE_ZONE_LEGEND, (chdkColor)
    {
        0,0
    }, NULL);
}
...
static const char* gui_zebra_mode_modes[] = { "Blink 1", "Blink 2", "Blink 3", "Solid", "Zebra 1", "Zebra 2", "Zones" };
static const char* gui_zebra_draw_osd_modes[] = { "Nothing", "Histo", "OSD" };
static const char* gui_zebra_rgb_fn_modes[] = { "HighLgt", "HighSat"};
...
static CMenuItem zebra_submenu_items[] =
{
    ...
    MENU_ENUM2(0x5f,LANG_MENU_ZEBRA_RGB_FN,           &conf3.zebra_rgb_fn, gui_zebra_rgb_fn_modes ),
    MENU_ITEM(0x35,LANG_MENU_OPEN_ZONE_FILE,          MENUITEM_PROC,		gui_zones_load, 0 ),
    MENU_ITEM(0x0, LANG_STR_CURRENT_ZONE_SYSTEM,      MENUITEM_SEPARATOR, 0, 0 ),
    MENU_ITEM(0x0,(int)conf2.zebra_zone_title,        MENUITEM_TEXT,      0, 0 ),
    MENU_ITEM(0x0,(int)"",                            MENUITEM_SEPARATOR, 0, 0 ),
    MENU_ITEM(0x65,LANG_MENU_SHOW_ZONE_LEGEND,        MENUITEM_PROC,      gui_menu_zone_legend, 0 ),
    MENU_ITEM(0x51,LANG_MENU_BACK,                    MENUITEM_UP, 0, 0 ),
    {0}
};
