...
typedef struct {
    char zebra_zone_file[CONF_STR_LEN];
    char zebra_zone_title[36];
} Conf2;

typedef struct {
    int parade_mode;
    int values_show_color_temp_tint;
    int values_show_overexp_percent;
    int values_show_auto_ev_comp;
    int zebra_rgb_fn;
} Conf3;

typedef struct {
    int auto_ev_ae_value;
    int overexp_percent;
} Vars;
